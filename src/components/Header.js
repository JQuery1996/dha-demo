...
function Header() {
    ...
    // get current user.
    const { user } = useAuth();
    // sidebar content depends on the role of the current logged user.
    const sidebarContent = SIDEBARCONTENT[user.role];
    const sidebarOtherContent = SIDEBAROTHERCONTENT[user.role];
    const sidebarSettingsContent = SIDEBATSETTINGSCONTENT[user.role];

    const toggleOpen = () => setIsOpen((currentState) => !currentState);
    const toggleActive = () => setIsActive((currentState) => !currentState);
    const toggleisNoti = () => setisNoti((currentState) => !currentState);
    ...
    return (
        <div className="nav-header bg-white shadow-xs border-0">
            <div className="nav-top">
                ...
                <Link
                    to={PATH_APP.DefaultMessage.root}
                ...
                <Link to={PATH_APP.DefaultVideo.root} className="mob-menu me-2">
            ...
            <Darkbutton />
            <Link
                to={PATH_APP.DefaultSettings.root}
                ...
                <div className="container ps-0 pe-0">
                    <div className="nav-content">
                        ...
                        <div className="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2">
                            ...
                            <ul className="mb-3">
                                {sidebarOtherContent.map(
                                    (otherContent, index) => (
                                        <li key={index}>
                                            <Link
                                                to={PATH_APP.DefaultHotel.root}
                                                className="nav-content-bttn open-font"
                                            >
                                                <i
                                                    className={
                                ...
                                {/* <li>
                                    <Link
                                        to={PATH_APP.DefaultEmailBox.root}
                                        className="nav-content-bttn open-font"
                                    >
                        ...
                        <div className="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1">
                            ...
                            <ul className="mb-1">
                                <li className="logo d-none d-xl-block d-lg-block"></li>
                                {sidebarSettingsContent.map(
                                    (settingContent, index) => (
                                        <li key={index}>
                                            <Link
                                                to="/"
                                ...
                                <li>
                                    <Link
                                        to={PATH_APP.DefaultAnalytics.root}
                                        className="nav-content-bttn open-font h-auto pt-2 pb-2"
                                    >
